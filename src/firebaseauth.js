...
document.getElementById('signin').addEventListener('click', function() {
    ...
    if (email === '' || password === '') {
        ...
        document.getElementById('signInMessage').innerText = 'Please enter both email and password.';
        return;
    }

    // Simulate an API call to check credentials (replace this with actual API call)
    const validEmail = ''; // Replace with actual email check
    const validPassword = 'password123'; // Replace with actual password check
